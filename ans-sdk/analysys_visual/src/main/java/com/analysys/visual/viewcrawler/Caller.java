    ...
    public Object applyMethodWithArguments(View target, Object[] arguments) {
        ...
        if (mTargetClass.isAssignableFrom(klass)) {
            try {
                ...
                InternalAgent.e(TAG, "Method " + mTargetMethod.getName() + " appears not to be " +
                        "public", e);
            } catch (final IllegalArgumentException e) {
                InternalAgent.e(TAG, "Method " + mTargetMethod.getName() + " called with " +
                        "arguments of the wrong type", e);
            } catch (final InvocationTargetException e) {
                InternalAgent.e(TAG, "Method " + mTargetMethod.getName() + " threw an exception",
                        e);
            }
        }
